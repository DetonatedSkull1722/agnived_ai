...
CLOUD_PROJECT_NAME = "our-lamp-465108-a9"
...
# -----------------------------------------------------------------------------#
def init_earth_engine(project: str | None = CLOUD_PROJECT_NAME) -> None:
...
def load_reben_model(device: torch.device) -> torch.nn.Module:
    ...
    # legacy_reben = SCRIPT_DIR / "Test_Satellite" / "reben"
...
if __name__ == "__main__":
    ...
    mask_path = SCRIPT_DIR / "Final_Res_DW" / "vegetation_mask.tif"
